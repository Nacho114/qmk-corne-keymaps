...
const uint16_t PROGMEM combo_lctlq[] = {KC_LCTL, KC_Q, COMBO_END};
// COMBO_COUNT is set in config.h
combo_t key_combos[COMBO_COUNT] = {
    COMBO(combo_uy, KC_ESC), 
    COMBO(combo_lctlq, KC_ESC), 
};
...
LT(_MENU,KC_TAB), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_BSPC,
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	KC_LSFT,LALT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                      TT(_NAV), LT(_NUM, KC_BSPC), KC_LGUI,       LALT_T(KC_ENT),  LT(_SYM, KC_SPC),  QK_LEAD
                                      //`--------------------------'  `--------------------------'
	),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,   KC_NO,   KC_NO, KC_PPLS, KC_PMNS, KC_TILD,                        KC_NO,  KC_EQL, KC_PAST, KC_PSLS,   KC_NO,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
LT(_MENU,KC_TAB), KC_Q,	   KC_W,   	KC_F,    KC_P,    KC_B, 					              KC_J,    KC_L,    KC_U,    KC_Y, KC_QUOT, KC_BSPC,
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL,    KC_A,    KC_R,    KC_S,     KC_T,   KC_G, 						            KC_M, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,  KC_SCLN,
	//|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	KC_LSFT,LALT_T(KC_Z),    KC_X,    KC_C,    KC_D,    KC_V, 						            KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS,
	//|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                      TT(_NAV), LT(_NUM, KC_BSPC), KC_LGUI,       LALT_T(KC_ENT),  LT(_SYM, KC_SPC),  QK_LEAD
